 ...
 *
 * $Id: init.php 3343 2008-03-02 20:32:11Z mundaun $
...
require_once('class.tx_remoteserver_beuserauth.php');
...
$BE_USER = t3lib_div::makeInstance('tx_remoteserver_beuserauth');	// New backend user object
